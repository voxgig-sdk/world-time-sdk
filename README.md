...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/world-time` | `npm install @voxgig-sdk/world-time` |
| Python | `voxgig-sdk-world-time` | `pip install voxgig-sdk-world-time` |
| PHP | `voxgig-sdk/world-time` | `composer require voxgig-sdk/world-time` |
| Golang | `github.com/voxgig-sdk/world-time-sdk/go` | `go get github.com/voxgig-sdk/world-time-sdk/go` |
| Ruby | `voxgig-sdk-world-time` | `gem install voxgig-sdk-world-time` |
| Lua | `voxgig-sdk-world-time` | `luarocks install voxgig-sdk-world-time` |
