...
The Golang SDK for the WorldTime API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/world-time-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/world-time-sdk=../path/to/github.com/voxgig-sdk/world-time-sdk
```
...
```
github.com/voxgig-sdk/world-time-sdk/
...
The root package (`github.com/voxgig-sdk/world-time-sdk`) re-exports everything needed
