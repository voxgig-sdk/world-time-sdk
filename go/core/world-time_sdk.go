...
func (sdk *WorldTimeSDK) OptionsMap() map[string]any {
...
func (sdk *WorldTimeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WorldTimeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WorldTimeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldTimeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WorldTimeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WorldTimeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WorldTimeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WorldTimeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldTimeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WorldTimeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
