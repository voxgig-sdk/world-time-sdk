...
func NewTimezoneEntity(client *core.WorldTimeSDK, entopts map[string]any) *TimezoneEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TimezoneEntity) GetName() string { return e.name }
...
func (e *TimezoneEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TimezoneEntity) Deleted() bool {
	return e.deleted
}


func (e *TimezoneEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTimezoneEntity(e.client, opts)
}

func (e *TimezoneEntity) Data(args ...any) any {
...
func (e *TimezoneEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Timezone; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TimezoneEntity) DataTyped(data ...Timezone) Timezone {
	if len(data) > 0 {
		return typedFrom[Timezone](e.Data(asMap(data[0])))
	}
	return typedFrom[Timezone](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Timezone (all fields
// optional at the wire level).
func (e *TimezoneEntity) MatchTyped(match ...Timezone) Timezone {
	if len(match) > 0 {
		return typedFrom[Timezone](e.Match(asMap(match[0])))
	}
	return typedFrom[Timezone](e.Match())
}
...
func (e *TimezoneEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TimezoneEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TimezoneLoadMatch and returns an Timezone. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TimezoneEntity) LoadTyped(reqmatch TimezoneLoadMatch, ctrl map[string]any) (Timezone, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Timezone{}, err
	}
	return typedFrom[Timezone](res), nil
}




func (e *TimezoneEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TimezoneListMatch and returns []Timezone. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TimezoneEntity) ListTyped(reqmatch TimezoneListMatch, ctrl map[string]any) ([]Timezone, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Timezone](res), nil
}



func (e *TimezoneEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TimezoneEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TimezoneEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TimezoneEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
