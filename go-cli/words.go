...
func registerSDKWords(r *eng.Registry, client *sdk.WorldTimeSDK) {
...
func runOp(client *sdk.WorldTimeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
