...
func registerTools(server *mcp.Server, client *sdk.WorldTimeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "world-time_list",
		Description: "List records from WorldTime. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "world-time_load",
		Description: "Load a single record from WorldTime. " +
...
func runOp(client *sdk.WorldTimeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WorldTimeSDK, name string) (sdk.WorldTimeEntity, error) {
