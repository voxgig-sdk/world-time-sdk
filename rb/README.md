...
raise a `WorldTimeError` (a `StandardError` subclass), so wrap
...
| `day_of_week` | `Integer` | The day of the week (0-6, where 0 is Sunday) |
...
| `week_number` | `Integer` | The ISO week number of the year |
...
```
rb/
├── WorldTime_sdk.rb       -- Main SDK module
