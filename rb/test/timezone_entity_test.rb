...
class TimezoneEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WORLDTIME_TEST_TIMEZONE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def timezone_basic_setup(extra)
  ...
  entid_env_raw = ENV["WORLDTIME_TEST_TIMEZONE_ENTID"]
