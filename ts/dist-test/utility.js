...
function envOverride(m) {
    if ('TRUE' === process.env.WORLD_TIME_TEST_LIVE ||
        'TRUE' === process.env.WORLD_TIME_TEST_OVERRIDE) {
    ...
    m.WORLD_TIME_TEST_EXPLAIN = process.env.WORLD_TIME_TEST_EXPLAIN || m.WORLD_TIME_TEST_EXPLAIN;
    return m;
}
