...
(0, node_test_1.describe)('TimezoneDirect', async () => {
    // Per-test live pacing. Delay is read from sdk-test-control.json's
    // `test.live.delayMs`; only sleeps when WORLD_TIME_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('WORLD_TIME_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WorldTimeSDK({
    ...
    (0, node_test_1.test)('direct-load-timezone', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-timezone', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-timezone', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-timezone', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WorldTimeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['WORLD_TIME_TEST_TIMEZONE_ENTID'];
    ...
    const client = new __1.WorldTimeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TimezoneDirect.test.js.map