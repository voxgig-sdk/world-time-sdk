# WorldTime SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WorldTimeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WorldTimeSDK(...) and WorldTimeSDK.test(...) become
#      WorldTimeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "worldtime_sdk"
_SDK_CLASS = "WorldTimeSDK"
