...
class WorldTimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldTimeTestRunner.getenv("WORLDTIME_TEST_LIVE")
        override = WorldTimeTestRunner.getenv("WORLDTIME_TEST_OVERRIDE")
        ...
        explain = WorldTimeTestRunner.getenv("WORLDTIME_TEST_EXPLAIN")
