...
from worldtime_sdk.core.helpers import get_ctx_prop, to_map
...
class WorldTimeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, WorldTimeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WorldTimeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WorldTimeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WorldTimeError(code, msg, self)
