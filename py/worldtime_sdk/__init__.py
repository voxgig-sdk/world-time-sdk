...
from worldtime_sdk.utility import register

# Load features
from worldtime_sdk.feature.base_feature import WorldTimeBaseFeature
from worldtime_sdk.features import _has_feature, _make_feature
...
class WorldTimeSDK:
    ...
    def get_utility(self):
        return WorldTimeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WorldTimeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Ipn(self, data=None) -> "IpnEntity":
        ...
        from worldtime_sdk.entity.ipn_entity import IpnEntity
    ...
    def Timezone(self, data=None) -> "TimezoneEntity":
        ...
        from worldtime_sdk.entity.timezone_entity import TimezoneEntity
