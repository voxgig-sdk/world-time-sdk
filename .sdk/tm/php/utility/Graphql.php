...
class WorldTimeGraphql
{
    ...
    // equivalent.
    public static function body(WorldTimeContext $ctx): mixed
    {
    ...
    public static function errors(WorldTimeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
