...
// WorldTime SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WorldTimeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WorldTimeOmni::structfix($now, Struct::undef()))
                        !== json_encode(WorldTimeOmni::structfix($val, Struct::undef()))) {
