...
class WorldTimeCacheFeature extends WorldTimeBaseFeature
{
    ...
    private function _through(WorldTimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
