...
class WorldTimeTimeoutFeature extends WorldTimeBaseFeature
{
    ...
    private function _with_timeout(WorldTimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WorldTimeContext $_ctx, float $ms): void
    {
        $client = $this->client;
