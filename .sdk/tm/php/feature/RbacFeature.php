...
class WorldTimeRbacFeature extends WorldTimeBaseFeature
{
    ...
    private function _required(WorldTimeContext $ctx): ?string
    {
    ...
    private function _reject(WorldTimeContext $ctx, string $required): void
    {
    ...
    private function _track(WorldTimeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
