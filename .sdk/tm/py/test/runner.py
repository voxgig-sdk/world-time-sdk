...
class WorldTimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldTimeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WorldTimeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WorldTimeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
