...
class WorldTimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldTimeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WorldTimeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WorldTimeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
