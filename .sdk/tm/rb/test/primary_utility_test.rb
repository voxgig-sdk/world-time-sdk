...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = WorldTimeOmni.make_runner(TEST_JSON_FILE, WorldTimeSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : WorldTimeOmni.errify(err)
    end
