...
|---|---|---|
| `ts/` | @voxgig-sdk/world-time-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/world-time-sdk \
      --repository voxgig-sdk/world-time-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/world-time-sdk` shows it, and
`npm trust revoke @voxgig-sdk/world-time-sdk --id=<id>` removes it.
