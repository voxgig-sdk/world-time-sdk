...
// WorldTime SDK ratelimit feature
...
class WorldTimeRatelimitFeature extends WorldTimeBaseFeature
{
    ...
    private function _acquire(WorldTimeContext $ctx): void
    {
    ...
    private function _track(WorldTimeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
