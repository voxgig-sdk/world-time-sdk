...
// WorldTime SDK streaming feature
...
class WorldTimeStreamingFeature extends WorldTimeBaseFeature
{
    ...
    private function _iterate(WorldTimeResult $result): \Generator
    {
    ...
    private function _streamable(WorldTimeContext $ctx): bool
    {
