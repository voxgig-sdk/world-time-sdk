...
class WorldTimeProxyFeature extends WorldTimeBaseFeature
{
    ...
    public function init(WorldTimeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WorldTimeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
