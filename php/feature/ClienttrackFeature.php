...
// WorldTime SDK clienttrack feature
...
class WorldTimeClienttrackFeature extends WorldTimeBaseFeature
{
    ...
    public function PostConstruct(WorldTimeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WorldTime-SDK';
