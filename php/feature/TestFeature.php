...
// WorldTime SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WorldTimeTestFeature extends WorldTimeBaseFeature
{
    ...
    public function init(WorldTimeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WorldTimeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WorldTimeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WorldTimeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WorldTimeContext $ctx, $op, $args): array
    {
