...
// WorldTime SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class WorldTimeTransformResponse
{
    public static function call(WorldTimeContext $ctx): mixed
    {
        ...
        $transform = WorldTimeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
