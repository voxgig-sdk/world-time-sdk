...
class WorldTimeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WorldTimeSDK/1.0)';
    ...
    public static function call(WorldTimeContext $ctx, string $fullurl, array $fetchdef): array
    {
