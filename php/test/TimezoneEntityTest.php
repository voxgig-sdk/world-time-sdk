...
class TimezoneEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WORLD_TIME_TEST_TIMEZONE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function timezone_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WORLD_TIME_TEST_TIMEZONE_ENTID");
