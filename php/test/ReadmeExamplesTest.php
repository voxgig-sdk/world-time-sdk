...
// WorldTime SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WorldTimeSDK::test)
...
{
    private const SDK_CLASS = 'WorldTimeSDK';
    ...
    private const SDK_BASE = 'worldtime_sdk';
